...
<div class="container" style="padding-top:50px">
  ...
  <h2 class="txt-center" style="color:#3C1363">TERMS AND POLICY</h2>
  <hr>
  <div style="padding-top:10px">
    <p class="txt-center" >
      No matter where you live in Karachi, we provide our amazing service all over the city.
      You can get your institute registered whenever you want.
      This website is operated by Copedia. Throughout the site, the terms “we”, “us” and “our” refer to Copedia. Copedia offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.<br>

            By visiting our site and/or purchasing any deal from us, you engage in our “Service” and agree to be bound by the following terms and conditions (“Terms of Service”, “Terms”), including those additional terms and conditions and policies referenced herein and/or available by hyperlink. These Terms of Service apply to all users of the site, including without limitation users who are browsers, vendors, customers, merchants, and/or contributors of content.<br>
    ...
    <table class="table table-bordered" >
      ...
      <thead>
        <tr>
          <th colspan="4" scope="col"><font>SECTION 1 - ONLINE DEAL TERMS</font></th>
        </tr>
      </thead>
      <tbody style="margin-bottom:30px">
        <tr>
          <td colspan="4"> By agreeing to these Terms of Service, you represent that you are at least the age of majority in your state or province of residence, or that you are the age of majority in your state or province  of residence and you have given us your consent to allow any of your minor dependents to use this site.<br>You may not use our website for any illegal or unauthorized purpose nor may you, in the use of the Service, violate any laws in your jurisdiction (including but not limited to copyright laws).<br>
              You must not transmit any worms or viruses or any code of a destructive nature.<br>
              A breach or violation of any of the Terms will result in an immediate termination of your Services.</td>
        </tr>
       </tbody>
    </table>
    ...
    <table class="table table-bordered" >
      <thead>
          <tr>
            <th colspan="4" scope="col"><font>SECTION 2 - GENERAL CONDITIONS </font></th>
          </tr>
      </thead>
      <tbody>
          <tr>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col"><font>SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION </font></th>
          </tr>
      </thead>
      <tbody>
          <tr>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font> SECTION 5 - ACCURACY OF BILLING AND ACCOUNT INFORMATION </font>
            </th>
          </tr>
      </thead>
      <tbody>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font>SECTION 7 - THIRD-PARTY LINKS </font>
            </th>
          </tr>
      </thead>
      <tbody>
    ...
    <table class="table table-bordered" >
        <thead>
          <tr>
            <th colspan="4" scope="col">
              <font>SECTION 8 - ERRORS, INACCURACIES AND OMISSIONS </font>
            </th>
          </tr>
      </thead>
      <tbody>
